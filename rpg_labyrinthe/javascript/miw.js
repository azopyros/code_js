...
/******************************************************************************************************/
/***********************  Ajout de la fonction _rand(min,max)******************************************/
/******************************************************************************************************/
		//return un nombre entier compris entre min et max incluts
		_rand = function(min, max){
			 return Math.floor(Math.random()*(max-min+1)+min);
		};
/******************************************************************************************************/
/***********************  Ajout de la fonction z()**************************************************/
/******************************************************************************************************/
		//creer un log primitif des paramètres
		_log = function(){for(var i = 0; i<arguments.length; i++){console.log(arguments[i]);}};
			
		_print = function(a){return JSON.parse(JSON.stringify(a));};
})();
